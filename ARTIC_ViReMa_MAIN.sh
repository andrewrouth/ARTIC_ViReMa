...
if [[ "$STAGING" == *"N"* ]]; then
	...
	python3 $ScriptPath'Combine_unstranded_annotations.py' $Root'_ViReMa/BED_Files/'$Root'_Virus_Recombination_Results_WA1coords.bed' $Root'_ViReMa/BED_
Files/'$Root'_Virus_Recombination_Results_WA1coords_noDir.bed' -BED12 -Stranded
